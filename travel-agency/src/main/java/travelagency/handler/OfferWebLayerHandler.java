...
public class OfferWebLayerHandler {
    ...
    public OfferWebLayerHandler(TravelAgencyService travelAgencyService) {
        ...
        return updatedOffer
                .flatMap(offer -> {
                    ...
                    return ServerResponse.ok()
                            .contentType(MediaType.APPLICATION_JSON)
                            .body(
                                    travelAgencyService.updateOffer(id, hotel_name, image, country, city, stars, start_date,
    ...
    public Mono<ServerResponse> getOffers(ServerRequest request) {
        ...
        Flux<Offer> offers = travelAgencyService.fetchOffers(hotel_name, image, country, city, stars, start_date, end_date,
